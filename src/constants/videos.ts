...
export const MOCK_USERS = [
  ...
  { id: '6', name: 'Emma Davis', avatar: 'https://i.pravatar.cc/150?img=6' },
  { id: '7', name: 'Michael Wilson', avatar: 'https://i.pravatar.cc/150?img=7' },
  { id: '8', name: 'Sophia Martinez', avatar: 'https://i.pravatar.cc/150?img=8' },
  { id: '9', name: 'Daniel Anderson', avatar: 'https://i.pravatar.cc/150?img=9' },
